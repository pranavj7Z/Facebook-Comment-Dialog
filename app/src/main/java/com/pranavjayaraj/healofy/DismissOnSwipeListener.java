...
public class DismissOnSwipeListener implements View.OnTouchListener {
    ...
    /**
     * The callback interface used by {@link DismissOnSwipeListener} to inform its client
    ...
    public interface DismissCallbacks {
         ...
         */
        void onDismiss(View view, boolean totop, Object token);
    }
     ...
     *                 dismiss this view.
     */
    public DismissOnSwipeListener(View view, Object token, DismissCallbacks callbacks) {
    ...
    private void performDismiss(final boolean toR) {
